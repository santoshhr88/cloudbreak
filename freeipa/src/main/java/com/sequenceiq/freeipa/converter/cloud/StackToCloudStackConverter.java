...
public class StackToCloudStackConverter implements Converter<Stack, CloudStack> {
    ...
    private List<Group> buildInstanceGroups(Stack stack, List<InstanceGroup> instanceGroups, StackAuthentication stackAuthentication, Collection<String> deleteRequests,

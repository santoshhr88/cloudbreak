...
public class InstanceGroupV1ToInstanceGroupV4Converter {
    ...
    private InstanceGroupNetworkV4Request getInstanceGroupNetworkV4Request(NetworkV1Request distroxNetwork, InstanceGroupV1Request source, DetailedEnvironmentResponse environment) {
